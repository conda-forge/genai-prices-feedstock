...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/genai-prices-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/genai-prices-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add genai-prices
# for installing globally
pixi global install genai-prices
```
...
It is possible to list all of the versions of `genai-prices` available on your platform:
...
```
pixi search genai-prices --channel conda-forge
```
